        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
          <div className="max-w-md p-8 border rounded-2xl border-white/10 bg-white/5">
            ...
            <div className="flex flex-col gap-3">
              <Link href="/login">
                <button className="flex items-center justify-center w-full gap-2 py-3 font-semibold text-white bg-orange-500 rounded-xl hover:bg-orange-600">
                  <LogIn size={18} />
                  Login
                </button>
              </Link>
              <Link href="/register">
                <button className="flex items-center justify-center w-full gap-2 py-3 font-semibold text-white border border-orange-500 rounded-xl hover:bg-orange-500/10">
                  <UserPlus size={18} />
                  Register
                </button>
              </Link>
